...
const a = '-Z --debug -J defs.json -oout.js --style=c -Estuff=[auto_complete,auto_find_in_selection] -Fitem=item.txt test.ct --style=xml -Dhello=world stuff.xmlt'.split(/\s+/);
